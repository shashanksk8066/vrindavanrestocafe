                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {gallery.length > 0 ? (
                        <div className="columns-2 md:columns-3 lg:columns-4 gap-1 md:gap-2">
                            {gallery.map((img) => (
                                <div key={img.id} className="mb-1 md:mb-2 relative rounded-2xl overflow-hidden shadow-sm group break-inside-avoid cursor-pointer" onClick={() => setSelectedMedia(img.imageUrl)}>
