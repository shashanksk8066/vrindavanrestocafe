            ...
            <div className="w-full max-w-md relative z-10">
                <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 sm:p-10 overflow-hidden">
                    ...
                    <div className="flex flex-col items-center justify-center mb-8">
                        ...
                        <p className="text-gray-500 mt-2 text-center text-sm font-medium">Sign in to continue to Vrindavan Resto Cafe</p>
                    </div>
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-100">
                        <p className="text-center text-sm text-gray-600">
                            ...
                            <Link to="/signup" className="font-bold text-amber-600 hover:text-amber-500 transition-colors">Create one now</Link>
                        </p>
                    </div>
                </div>
